...
/* Acciones asincronas, deben devolver una función */
export function fetchPeople () {
  return function (dispatch) {
    dispatch(fetchPeopleRequest());  // despacha una acción
    apiClient.loadPeople().then((people) => { // realiza una accion asincrona
      dispatch(fetchPeopleSuccess(people))  // despacha una acción, en este caso success
    })
  }
}
